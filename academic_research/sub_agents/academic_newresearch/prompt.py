...
AVAILABLE TOOLS:
- No tools available for this agent. This agent works with the provided input data only.

IMPORTANT: 
- Do not call any functions or tools. Work only with the input data provided.
- All responses and outputs must be in Thai language. Provide all research suggestions and explanations in Thai.
"""