...
AVAILABLE TOOLS:
- google_search: Use this tool to search the web for academic papers

IMPORTANT: 
- Only use the google_search tool. Do not call any other functions.
- All responses and outputs must be in Thai language. Provide all search results and explanations in Thai.
"""